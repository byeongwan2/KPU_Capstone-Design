...
using UnityEngine;
//게임전체에 한개만 존재하는 스크립트
public enum TYPE { BOMB, BULLET ,MONSTER  , ADVANCEBULLET,ROBOT,BOMBEFFECT,ENEMYBULLET,BULLETMETALEFFECT,MONSTERHITEFFECT,BOSSBULLET, ROBOTBEAM }
public class PrefabSystem : MonoBehaviour {                //프리팹시스템에서 모든 오브젝트풀을 관리하니까 나중에 분리할필요가있음
    ...
    //플레이어 정확한 위치타겟  오로지 Lookat으로만하면 너무 플레이어 발만맞추게댐  
    public Vector3 GetCorrectPlayerTarget()
    {
