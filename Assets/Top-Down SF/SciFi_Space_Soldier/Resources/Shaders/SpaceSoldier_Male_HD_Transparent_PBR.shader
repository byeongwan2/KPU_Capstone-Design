Shader "PolygonR/SpaceSoldier_Male_HD_PBR_Transparent" {
	Properties {
	...
	SubShader {
		...
		half _Glossiness, _Metallic, _EmissionFactor, _BumpScale, _OcclusionStrength, _RoughLerp, _Opacity;
